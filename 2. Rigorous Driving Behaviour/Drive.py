...
speed_limit = 15 # Speed limit <=15 for Mountain Track, <=25 for Lake Track
...
if __name__ == '__main__':
    model = tf.keras.models.load_model('Rigorous_Driving_Behaviour_Model.h5') # Load the trained model
