...
speed_limit = 25 # Speed limit <=10 for Mountain Track, <=25 for Lake Track
...
def telemetry(sid, data):
    if data:
        ...
        try:
            ...
            image = data_preprocessor(image) # Apply the image pre-processing
...
if __name__ == '__main__':
    model = tf.keras.models.load_model('Collision_Avoidance_Behaviour_Model.h5') # Load the trained model
